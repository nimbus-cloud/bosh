...
export BAT_STEMCELL=$PWD/tmp/bosh-stemcell-3312.17.1-vsphere-esxi-ubuntu-trusty-go_agent.tgz
export BAT_DEBUG_MODE=true
export UNSUPPORTED_BATS=dns,raw_ephemeral_storage,vip_networking

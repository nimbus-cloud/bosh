    ...
    module DeploymentPlan
      class InstancePlan
        ...
        def changes
          ...
          @changes << :passive if instance.passive_changed?(@desired_instance.job)
          @changes << :drbd if instance.drbd_changed?(@desired_instance.job)
          @changes << :register_dns if instance.register_dns_changed?(@desired_instance.job)
          @changes
        end

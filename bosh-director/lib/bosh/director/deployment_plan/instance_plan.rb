    ...
    module DeploymentPlan
      class InstancePlan
        ...
        def changes
          ...
          @changes << :passive if instance.passive_changed?(@desired_instance.instance_group)
          @changes << :drbd if instance.drbd_changed?(@desired_instance.instance_group)
          @changes << :register_dns if instance.register_dns_changed?(@desired_instance.instance_group)
          @changes
        end
